...
export default function GiftListSection() {
  ...
  const [visibleCount, setVisibleCount] = useState(GIFTS_PER_PAGE);
  ...
  const showMoreGifts = () => {
    setVisibleCount((prevCount) => prevCount + GIFTS_PER_PAGE);
  };
      ...
      <div className="container px-4 md:px-6">
        ...
        {visibleCount < gifts.length && (
          <div className="mt-12 text-center">
            <Button onClick={showMoreGifts} size="lg">Ver mais presentes</Button>
          </div>
        )}
      </div>
    </section>
