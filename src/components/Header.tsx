...
export default function Header() {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 z-50 w-full transition-all duration-700 transform",
        isScrolled 
        ? "bg-white/80 shadow-md backdrop-blur-sm translate-y-0 opacity-100 py-2" 
        : "-translate-y-full opacity-0 py-4",
      )}
    >
