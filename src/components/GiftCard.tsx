  ...
  const handleContributeClick = () => {
    ...
    if (!contributorName.trim()) {
      toast({
        ...
        description:
          "Por favor, preencha seu nome para sabermos quem agradeçer!",
      });
      return;
    }
      ...
      <CardFooter className="pt-2 pb-4">
        <div className="flex w-full gap-2">
          ...
          {!isGoalReached ? (
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              ...
              <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Faça sua contribuição via PIX e registre abaixo para
                    sabermos que foi você!
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6 pt-4">
                  <div className="bg-muted/50 p-4 rounded-lg border border-border flex flex-col items-center gap-3">
                    ...
                    >
                      <Link
                        href="https://nubank.com.br/cobrar/pquj/6956ef41-a9d8-4e68-92dc-882088310601"
                        target="_blank"
                      >
            ...
            <Button
              className="flex-1 bg-muted text-muted-foreground hover:bg-muted cursor-not-allowed"
              disabled
            >
